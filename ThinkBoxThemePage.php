 ...
 <div id="top-nav">
    ...
    <div class="content-page">
        <div id="themes-container">
            <div class="theme-option" id="theme1" onclick="selectTheme('theme1')">Theme 1</div>
            <div class="theme-option" id="theme2" onclick="selectTheme('theme2')">Theme 2</div>
            <div class="theme-option" id="theme3" onclick="selectTheme('theme3')">Theme 3</div>
            <div class="theme-option" id="theme4" onclick="selectTheme('theme4')">Theme 4</div>
        </div>
        <div id="selected-theme">Selected Theme: Default</div>
    </div>
